...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-start items-center px-4 py-8 sm:px-6 relative overflow-y-auto" style={{
      ...
      <div className="max-w-lg w-full flex flex-col items-center gap-4 sm:gap-5 relative z-10" style={{ marginTop: '0' }}>
        ...
        <div className="text-center space-y-1 mb-1">
          <h1 className="text-5xl sm:text-6xl font-light tracking-[0.4em] text-white drop-shadow-2xl">
            V E R A
          </h1>
        ...
        {/* Description */}
        <div className="text-center max-w-md space-y-1 px-4 mb-2">
        ...
        {/* Trial badge */}
        <div className="px-5 py-2 rounded-full border-2 border-white/30 bg-white/10 backdrop-blur-md mb-3">
            ...
            <>
              <div className="relative">
                <input
                  ...
                  className="w-full px-6 py-4 rounded-2xl bg-white/95 backdrop-blur-sm text-gray-900 placeholder:text-gray-400 text-center text-base font-medium focus:outline-none focus:ring-4 focus:ring-orb-purple/40 shadow-2xl transition-all"
                  required
                />
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full px-6 py-5 rounded-2xl bg-purple-600 hover:bg-purple-500 text-white text-lg font-bold tracking-wide hover:scale-[1.01] active:scale-[0.99] transition-all disabled:opacity-60 disabled:cursor-not-allowed shadow-xl"
              >
              ...
              <p className="text-xs text-white/70 text-center leading-relaxed px-4">
